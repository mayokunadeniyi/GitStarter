...
const IndexPage = () => (
  <div>
    <h1>Hello LMU Developers! &nbsp;<i className="em em-wave"></i></h1>
    ...
    <p>
      ...
      we'll simply give the name of the branch as above. eg: <i>git branch mayokunthefirst-profile</i>. Once you have created the new branch we'll change the current brach from master to your newly created branch.
    ...
    <p>
      ...
      It should look like <b>YOUR_USER_NAME.md</b> <i>eg: mayokunthefirst.md </i><br/>
    ...
    <h3>Step 7</h3>
    <p>
      Now, open your web browser and goto the <a target="_blank" href="https://github.com/mayokunthefirst/GitStarter"> original repository on GitHub</a>. If your changes has been pushed to your forked copy, You'll be able to see an option saying "New Pull Request" in the original repository.
